const cards = [ 
  ['Action (set A)', 'Action (set B)', 'Animal (set A)', 'Animal (set B)', 'Clothes', 'Emotions', 'Transport', 'Nature'],
  [
    {
      word: 'cry',
      translation: 'плакать',
  ...
  [
    ...
    },
    {
      ...
      audioSrc: 'assets/audio/bike.mp3'
    },
    {
      word: 'bus',
      translation: 'автобус',
    ...
    },
    {
      ...
      audioSrc: 'assets/audio/helicopter.mp3'
    },
    {
      word: 'plane',
      translation: 'самолет',
